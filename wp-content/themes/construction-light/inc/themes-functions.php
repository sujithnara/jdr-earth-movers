...
if ( ! function_exists( 'construction_light_footer_copyright' ) ){
    ...
    function construction_light_footer_copyright() {
        ...
        echo esc_html( apply_filters( 'construction_light_copyright_text', $content = esc_html__('Copyright  &copy; ','construction-light') . date( 'Y' ) . ' ' . get_bloginfo( 'name' ) .' | Website Managed by Sujith Nara (+91 9043804260)' ) );
